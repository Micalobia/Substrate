...
namespace Substrate
{
    ...
    public static class BlockType
    {
        ...
        public const int STILL_WATER = 9;
        ...
        public const int LAPIS_LUZULI_BLOCK = 22;
        ...
        public const int RED_BUSHROOM = 40;
        ...
        public const int OAK_WOOD_STAIRS = 53;
        ...
        public const int WHEAT_CROPS = 59;
        ...
        public const int OAK_DOOR_BLOCK = 64;
        ...
        public const int IRON_DOOR_BLOCK = 71;
        ...
        public const int OAK_FENCE_GATE = 107;
        public const int BRICK_STAIRS = 108;
        public const int STONE_BRICK_STAIRS = 109;
        public const int MYCELIUM = 110;
        public const int LILY_PAD = 111;
        public const int NETHER_BRICK_BLOCK = 112;
        ...
        public const int DOUBLE_PLANK_SLAB = 125;
        public const int PLANK_SLAB = 126;
        ...
        public const int MOB_HEAD = 144;
        public const int ANVIL = 145;
        public const int TRAPPED_CHEST = 146;
        public const int GOLD_PRESSURE_PLATE = 147;
        public const int IRON_PRESSURE_PLATE = 148;
        public const int REDSTONE_COMPARATOR_OFF = 149;
        public const int REDSTONE_COMPARATOR_ON = 150;
        ...
        public const int STAINED_TERRACOTTA = 159;
        ...
        public const int RED_STANDSTONE_SLAB = 182;
        ...
        public const int DOUBLE_PURPUR_SLAB = 204;
        public const int PURPUR_SLAB = 205;
        public const int END_STONE_BIRCKS = 206;
